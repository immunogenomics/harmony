...
do_scatter <- function(umap_use, meta_data, label_name, no_guides = TRUE, do_labels = TRUE, nice_names, 
    ...
    # if (do_labels) 
    #     plt <- plt + geom_label(data = data.table(plt_df)[, .(X1 = mean(X1), X2 = mean(X2)), by = label_name], label.size = NA,
...
For more details on how each part of Harmony works, consult our more detailed vignette ["Detailed Walkthrough of Harmony Algorithm"](software.broadinstitute.org/harmony/vignettes/walkthrough.html). 
