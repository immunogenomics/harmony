...
#### lambda
Lambda controls the ridge regression penalty in the correction step values are 1 are expected to work well.
...
pbmc <- pbmc %>% 
    RunHarmony("stim", theta = 2, lambda = .1, plot_convergence = TRUE, 
